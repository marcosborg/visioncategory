                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('message') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="message" id="message" value="{{ old('message', $testimonial->message) }}">
                        ...
                        <div class="form-group {{ $errors->has('job_position') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="job_position" id="job_position" value="{{ old('job_position', $testimonial->job_position) }}">
