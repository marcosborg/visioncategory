                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hero-banners.update", [$heroBanner->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $heroBanner->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $heroBanner->subtitle) }}">
                        ...
                        <div class="form-group {{ $errors->has('text') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="text" id="text">{{ old('text', $heroBanner->text) }}</textarea>
                            @if($errors->has('text'))
                        ...
                        <div class="form-group {{ $errors->has('button') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="button" id="button" value="{{ old('button', $heroBanner->button) }}">
                        ...
                        <div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $heroBanner->link) }}">
                            @if($errors->has('link'))
