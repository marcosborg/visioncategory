                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-VehicleBrand">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.vehicleBrand.fields.name') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                                    ...
                                    <tr data-entry-id="{{ $vehicleBrand->id }}">
                                        ...
                                        <td>
                                            @can('vehicle_brand_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.vehicle-brands.show', $vehicleBrand->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('vehicle_brand_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.vehicle-brands.edit', $vehicleBrand->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('vehicle_brand_delete')
                                                <form action="{{ route('admin.vehicle-brands.destroy', $vehicleBrand->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
