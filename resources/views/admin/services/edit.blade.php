                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="text" id="text" value="{{ old('text', $service->text) }}" required>
                            @if($errors->has('text'))
                        ...
                        <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="icon" id="icon" value="{{ old('icon', $service->icon) }}" required>
                            @if($errors->has('icon'))
